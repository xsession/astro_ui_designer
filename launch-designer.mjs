...
server.listen(port,host,()=>{console.log(`Astro UI Designer Pro 2.17.2 Direct Manipulation + Project Import + Qt/QML is running at ${url}`);console.log('Local workspace API enabled. Press Ctrl+C to stop.');openWindow()});
