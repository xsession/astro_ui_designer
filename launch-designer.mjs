...
server.listen(port,host,()=>{console.log(`Astro UI Designer Pro 2.15 Global Tooltips + Draw.io + Relocatable Docks + Round-trip is running at ${url}`);console.log('Local workspace API enabled. Press Ctrl+C to stop.');openWindow()});
