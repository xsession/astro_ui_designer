...
export function createNode(type, overrides = {}) {
  ...
  return {
    ...
    design: deepClone(overrides.design || {constraints:{horizontal:'left',vertical:'top'},effects:{fills:[],strokes:[],shadows:[],blurs:[],blendMode:'normal'},exportPresets:[],interactions:[],fixedOnScroll:false,clipContent:false,aspectLocked:false,vector:{kind:'none',path:'',booleanOperation:'none'},libraryRef:'',manualLayout:{sizingX:'fixed',sizingY:'fixed',rotation:0,minWidth:'',maxWidth:'',minHeight:'',maxHeight:''}}),
...
export function createProject() {
  ...
  return {
    schemaVersion: 8, id: makeId('project'), name: 'astro-ui-project',
    settings: {
