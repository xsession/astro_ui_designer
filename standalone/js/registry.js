...
export const STYLE_GROUPS = [
  ...
  { name: 'Appearance', fields: [
    text('background','Background'), text('color','Color'), text('opacity','Opacity'), text('border','Border'), text('borderRadius','Radius'), text('boxShadow','Shadow'), text('outline','Outline'), text('filter','Filter'),
  ]},
