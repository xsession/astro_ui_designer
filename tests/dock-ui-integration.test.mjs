...
assert.match(app,/function ensureTabSearch/);
assert.match(app,/function applyTabFilter/);
assert.match(app,/function updateDockTabs/);
assert.match(app,/data-dock-close/);
assert.match(app,/data-dock-pin/);
assert.match(app,/function showPanelsDialog/);
assert.match(app,/function closeDockTabUi/);
assert.match(app,/function openDockTabUi/);
assert.match(app,/function toggleDockPinUi/);
assert.match(app,/function bindTabInteractionDelegation/);
assert.match(app,/view\.panels/);
assert.match(app,/data-doc-add/);
assert.match(css,/\.tab-search-input/);
assert.match(css,/\.doc-tab-close/);
assert.match(css,/\.doc-tab-pin/);
assert.match(css,/\.panel-dialog-row/);
