...
const tests=[
  ...
  'drawio-io.test.mjs','drawio-app-integration.test.mjs','runtime-modules.test.mjs','dock-layout.test.mjs','dock-ui-integration.test.mjs','tooltips.test.mjs','tooltips-app-integration.test.mjs',
];
