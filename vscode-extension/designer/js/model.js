...
export function createNode(type, overrides = {}) {
  ...
  return {
    ...
    design: deepClone(overrides.design || {constraints:{horizontal:'left',vertical:'top'},effects:{fills:[],strokes:[],shadows:[],blurs:[],blendMode:'normal'},exportPresets:[],interactions:[],fixedOnScroll:false,clipContent:false,aspectLocked:false,vector:{kind:'none',path:'',booleanOperation:'none'},libraryRef:''}),
...
export function createProject() {
  ...
  return {
    schemaVersion: 7, id: makeId('project'), name: 'astro-ui-project',
    settings: {
